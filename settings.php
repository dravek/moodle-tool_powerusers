...
if ($hassiteconfig) {
    ...
    $temp->add(
        new admin_setting_configtext(
            'tool_powerusers/superheroapitoken',
            new lang_string('apitoken', 'tool_powerusers'),
            new lang_string('apitoken_desc', 'tool_powerusers'),
            '',
            PARAM_TEXT
        )
    );
